...
function bellaworks_scripts() {
	...
	wp_enqueue_style( 'bellaworks-style', get_stylesheet_uri(), array( 'bellaworks-fonts' ), $ver );
	...
	wp_enqueue_script( 'bellaworks-custom', $dir . '/assets/js/custom.min.js', array( 'jquery' ), $ver, true );
